    ...
    if (loading) {
        ...
        return (
            <div>
                ...
                {(myCategories.strength.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
                {myCategories.aerobic.length > 0 && <h3 style={{ marginTop: "1rem", textAlign: "center" }}>
                    <i className="fas fa-running"></i>{' - '}Aerobics</h3>}
                {(myCategories.aerobic.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
                {myCategories.balance.length > 0 && <h3 style={{ marginTop: "1rem", textAlign: "center" }}>
                    <i className="fas fa-balance-scale"></i>{' - '}Balance</h3>}
                {(myCategories.balance.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
                {myCategories.agility.length > 0 && <h3 style={{ marginTop: "1rem", textAlign: "center" }}>
                    <i className="icon-dancing"></i>{' - '}Agility</h3>}
                {(myCategories.agility.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
                ...
                {(myCategories.flexibilityMobility.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
                {myCategories.notCatgorized.length > 0 && <h3 style={{ marginTop: "1rem", textAlign: "center" }}>Not categorized</h3>}
                {(myCategories.notCatgorized.map((ExerciseItem: { id: any; }) => <ExerciseCard ExerciseItem={ExerciseItem}
                    myStates={myStates}
                    key={ExerciseItem.id}
                />))}
            </div>
