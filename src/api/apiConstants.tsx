...
export const projectionExpressionGymDay = 'id,title,dateFrom,dateTo,description,workoutIdsJSON';
export const projectionExpressionWorkout = 'id,title,dateFrom,dateTo,description,exerciseIdsJSON';
