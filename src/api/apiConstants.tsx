...
export const projectionExpressionGymDay = 'id,title,dateFrom,dateTo,description,ExerciseItemIdsJSON,entertainmentItemIdsJSON,gymMembersJSON';
export const projectionExpressionGymMember = 'id,firstName,lastName,bio,jobTitle,email,restaurantIdsJSON,imageUrl,hideGymMember';
