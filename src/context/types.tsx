...
export const SET_WORKOUT_ITEMS = 'SET_GYM_DAY_ITEMS';
export const SET_WORKOUT_DIALOG_DATA = 'SET_GYM_DAY_DIALOG_DATA';
export const SET_WORKOUT_DIALOG_OPEN = 'SET_GYM_DAY_DIALOG_OPEN';
